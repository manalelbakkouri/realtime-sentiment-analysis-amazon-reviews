...
export default function SentimentTrends() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Tendances des sentiments</CardTitle>
      </CardHeader>
        ...
        {data.length > 0 ? (
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Legend />
              <Area type="monotone" dataKey="positive" stackId="1" stroke="#4ade80" fill="#4ade80" name="Positif" />
              <Area type="monotone" dataKey="neutral" stackId="1" stroke="#94a3b8" fill="#94a3b8" name="Neutre" />
              <Area type="monotone" dataKey="negative" stackId="1" stroke="#f87171" fill="#f87171" name="Négatif" />
            </AreaChart>
          </ResponsiveContainer>
        ) : (
