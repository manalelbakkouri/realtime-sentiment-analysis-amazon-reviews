  ...
  return (
    <div className="card">
      <div className="card-header">
        <h3 className="card-title">Analyse par produit (Top 10)</h3>
      </div>
      <div className="h-96">
        {data.length > 0 ? (
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              />
              <Legend />
              <Bar dataKey="positive" name="Positif" stackId="a" fill="#10b981" />
              <Bar dataKey="neutral" name="Neutre" stackId="a" fill="#6b7280" />
